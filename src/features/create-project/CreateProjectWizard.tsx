      ...
      <div className="mx-auto max-w-[1280px] px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-3 justify-end">
            ...
            <button className="rounded-full bg-[#111827] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#1f2937]">
              Continue
            </button>
          </div>
        </div>
        ...
        <div className="mt-14 flex justify-center">
          <div
            className={`w-full max-w-4xl rounded-[2rem] border border-dashed border-[#d9d9dc] bg-white px-8 py-16 text-center transition ${
              isDragActive ? "border-[#111827] bg-[#fafafa]" : "bg-white"
            }`}
          ...
          >
            ...
            <div className="mt-8 flex flex-col items-center gap-4">
              <p className="text-base font-semibold text-[#111827]">Drag and drop an image, or <span className="font-semibold text-[#111827] underline">Browse</span></p>
