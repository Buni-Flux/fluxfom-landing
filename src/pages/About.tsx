  ...
  return (
    <div className="min-h-full bg-flux-void text-white">
      <section className="landing-page-shell relative overflow-hidden border-b border-white/10 pb-16 pt-12 md:pb-24 md:pt-16">
        <div className="absolute -left-32 bottom-0 h-96 w-96 rounded-full bg-flux-neon/10 blur-3xl" aria-hidden />
        ...
        <div className="container relative mx-auto max-w-6xl px-5 sm:px-6">
          <div className="grid items-end gap-10 lg:grid-cols-12 lg:gap-10">
            <motion.div className="lg:col-span-7" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }}>
              ...
              <p className="landing-page-kicker">Studio</p>
              ...
              <p className="landing-page-copy mt-6 max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link to="/start" className="btn-neon-solid">
                  Start your brand
                </Link>
                <Link to="/projects" className="btn-neon-outline">
                  See client work
                </Link>
              </div>
            </motion.div>
          ...
          <ScrollNudge targetId="about-body" tone="dark" />
        </div>
      </section>

      <section id="about-body" className="bg-flux-void py-20 md:py-28">
        <div className="container mx-auto max-w-6xl px-5 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-12 lg:gap-14">
            <div className="lg:col-span-4">
              <p className="landing-page-kicker">Why we exist</p>
              <h2 className="heading-editorial mt-4 text-3xl font-semibold leading-tight text-white sm:text-4xl">
            ...
            <motion.div
              ...
              className="space-y-7 text-base leading-relaxed text-white/72 sm:text-lg lg:col-span-8"
            >
              {hasCmsContent ? (
                sections.map((s) => (
                  <div key={s.section_key} className="landing-page-card p-6">
                    {s.title && <h3 className="heading-editorial mb-3 text-2xl font-semibold text-white">{s.title}</h3>}
                    <p>{s.content}</p>
                  </div>
                ))
              ) : (
                <>
                  ...
                  <p className="heading-editorial rounded-[1.4rem] border border-white/10 bg-white/[0.04] p-6 text-2xl font-semibold leading-snug text-white">
      ...
      <section className="border-y border-white/10 bg-[#07140b] py-16 md:py-24">
        <div className="container mx-auto max-w-6xl px-5 sm:px-6">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="lg:order-1">
              <p className="landing-page-kicker">Ambition and discipline</p>
      ...
      <section className="bg-flux-void py-20 md:py-28">
        <div className="container mx-auto max-w-6xl px-5 sm:px-6">
          <motion.h2
            initial={{ opacity: 0, y: 16 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="heading-editorial text-center text-3xl font-semibold text-white sm:text-4xl md:text-5xl"
          >
          ...
          <div className="mx-auto mt-14 grid max-w-5xl gap-6 md:grid-cols-3">
            {VALUES.map((v, i) => (
              <motion.article
                ...
                className="landing-page-card p-7"
              >
                <p className="font-condensed text-4xl font-bold text-flux-neon">{String(i + 1).padStart(2, "0")}</p>
                <h3 className="heading-editorial mt-4 text-2xl font-semibold text-white">{v.title}</h3>
      ...
      <section className="border-t border-white/10 bg-gradient-to-br from-flux-forest to-flux-void py-20 text-white md:py-28">
        <div className="container mx-auto max-w-6xl px-5 sm:px-6">
          <div className="grid items-center gap-10 md:grid-cols-2 md:gap-16">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.08 }}>
              <p className="leading-relaxed text-white/72">Tell us what you are building and what must change in perception.</p>
              <Link
                to="/start"
